export const PROJECTS = [
  ...
  },
  {
    ...
    images: [
      ...
      "/assets/Zenith (15).png",
      "/assets/Zenith (16).png"
    ],
  },
  {
    id: 11,
    ...
    description:
      "Herramienta especializada para la generación inteligente de brochures corporativos de SENCOM, desarrollada para automatizar la creación de material comercial alineado a los lineamientos visuales y de comunicación de la empresa. El sistema permite cargar información como datasheets, país, sector objetivo y contactos opcionales, para que la plataforma genere brochures profesionales utilizando inteligencia artificial, evitando que el usuario tenga que diseñar manualmente el documento o alterar la identidad corporativa.",
    technologies: [
      "React",
      "Node.js",
      "Firebase",
    ...
    githubUrl: null,
    liveUrl: null,
    cover: "/assets/cover_brochure_new.png",
    images: [
      "/assets/Brochure_Generator (1).png",
      "/assets/Brochure_Generator (2).png",
  ...
  {
    id: 12,
    title: "Chilaquiles Top Landing Page",
    description:
      "Landing page moderna y estética desarrollada para Chilaquiles Top, enfocada en presentar visualmente la marca, sus productos y su propuesta comercial de forma clara, atractiva y adaptable a diferentes dispositivos. El proyecto fue construido con React y Node.js, priorizando diseño, estructura visual, experiencia de usuario y una presentación profesional para redirigir a los clientes hacia el proceso de pedidos.",
    technologies: [
      "React",
      "Node.js",
      "HTML",
    ...
    images: [
      ...
      "/assets/ChilaquilesTOP_LA (2).png",
      "/assets/ChilaquilesTOP_LA (3).png"
    ],
  },
  {
    id: 13,
    title: "Chilaquiles BOT",
    description:
      "Bot básico de atención para Chilaquiles Top, montado en Google Cloud y conectado directamente con WhatsApp Business. Fue desarrollado con Node.js e integra Gemini 3 Flash para responder preguntas frecuentes, brindar información general del negocio y redirigir a los clientes hacia la página de pedidos. El proyecto queda preparado para futuras mejoras, como la implementación directa de pedidos desde el bot, manejo de clientes y automatización avanzada del flujo de compra.",
    technologies: [
      "Node.js",
      "Google Cloud",
      "Gemini 3 Flash",
    ...
    images: [
      ...
      "/assets/Chilaquile_BOT (2).png",
      "/assets/Chilaquile_BOT (3).png"
    ],
  },
];
